...
struct IMGUI_API ImGuiWindow
{
    ...
    ImDrawCornerFlags       WindowCorners;
...
namespace ImGui
{
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f,ImDrawCornerFlags rounding_corners = ImDrawCornerFlags_All);
    IMGUI_API void          RenderFrameBorder(ImVec2 p_min, ImVec2 p_max, float rounding = 0.0f,ImDrawCornerFlags rounding_corners = ImDrawCornerFlags_All);
